<aside class="border-4 border-red main-sidebar" dir="ltr">
  ...
  <section class="sidebar">
    <div class="user-panel flex items-center px-4 py-3 space-x-3 rtl:space-x-reverse">
      <div class="order-2">
        <img src="{{ asset('img/house.png') }}" class="rounded-full" alt="House Image" style="width: 35px; height: 35px; object-fit: cover;">
      </div>
      <div class="order-1 flex-1">
        <p class="text-base font-medium" style="font-size: 19px; color: wheat; direction: rtl;">إدارة العقارات</p>
      </div>
    </div>
    ...
    <ul class="sidebar-menu">
      <li x-data="{ open: false }" class="border rounded-md mb-2">
        ...
        <ul x-show="open" x-transition class="pl-8 mt-2 space-y-1 text-gray-700">
          <li>
            <a href="{{ route('properties.index') }}" class="block px-4 py-2 rounded-lg text-gray-700 hover:bg-blue-500 hover:text-white transition duration-200">
              جميع العقارات
            </a>
          </li>
          <li>
            <a href="{{ route('properties.create') }}" class="block px-4 py-2 rounded-lg text-gray-700 hover:bg-blue-500 hover:text-white transition duration-200">
              إضافة عقار جديد
            </a>
          </li>
        </ul>
